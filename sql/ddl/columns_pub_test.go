...
var adminUserColumns = ddl.Columns{
	&ddl.Column{Field: "user_id", Pos: 1, Null: "NO", DataType: "int", Precision: null.MakeInt64(10), Scale: null.MakeInt64(0), ColumnType: "int(10) unsigned", Key: "PRI", Extra: "auto_increment", Comment: "User ID"},
	&ddl.Column{Field: "firstname", Pos: 2, Null: "YES", DataType: "varchar", CharMaxLength: null.MakeInt64(32), ColumnType: "varchar(32)", Comment: "User First Name"},
	&ddl.Column{Field: "lastname", Pos: 3, Null: "YES", DataType: "varchar", CharMaxLength: null.MakeInt64(32), ColumnType: "varchar(32)", Comment: "User Last Name"},
	&ddl.Column{Field: "email", Pos: 4, Null: "YES", DataType: "varchar", CharMaxLength: null.MakeInt64(128), ColumnType: "varchar(128)", Comment: "User Email"},
	&ddl.Column{Field: "username", Pos: 5, Null: "YES", DataType: "varchar", CharMaxLength: null.MakeInt64(40), ColumnType: "varchar(40)", Key: "UNI", Comment: "User Login"},
	&ddl.Column{Field: "password", Pos: 6, Null: "NO", DataType: "varchar", CharMaxLength: null.MakeInt64(255), ColumnType: "varchar(255)", Comment: "User Password"},
	...
	&ddl.Column{Field: "logdate", Pos: 9, Null: "YES", DataType: "timestamp", ColumnType: "timestamp", Comment: "User Last Login Time"},
	...
	&ddl.Column{Field: "extra", Pos: 13, Null: "YES", DataType: "text", CharMaxLength: null.MakeInt64(65535), ColumnType: "text", Comment: "User Extra Data"},
	&ddl.Column{Field: "rp_token", Pos: 14, Null: "YES", DataType: "longtext", CharMaxLength: null.MakeInt64(65535), ColumnType: "text", Comment: "Reset Password Link Token"},
	&ddl.Column{Field: "rp_token_created_at", Pos: 15, Null: "YES", DataType: "timestamp", ColumnType: "timestamp", Comment: "Reset Password Link Token Creation Date"},
	...
	&ddl.Column{Field: "first_failure", Pos: 18, Null: "YES", DataType: "timestamp", ColumnType: "timestamp", Comment: "First Failure"},
	&ddl.Column{Field: "lock_expires", Pos: 19, Null: "YES", DataType: "timestamp", ColumnType: "timestamp", Comment: "Expiration Lock Dates"},
	&ddl.Column{Field: "virtual_a", Pos: 20, Null: "YES", DataType: "timestamp", ColumnType: "timestamp", Extra: "VIRTUAL GENERATED", Generated: "ALWAYS", GenerationExpression: null.MakeString("`failures_num` MOD 10")},
