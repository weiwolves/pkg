...
func NewServiceEuroOZ(opts ...store.Option) *store.Service {
	defaultOpts := []store.Option{
		...
		store.WithGroups(
			&store.StoreGroup{GroupID: 3, WebsiteID: 2, Name: `Australia`, Code: `au`, RootCategoryID: 2, DefaultStoreID: 5},
			&store.StoreGroup{GroupID: 1, WebsiteID: 1, Name: `DACH Group`, Code: `dach`, RootCategoryID: 2, DefaultStoreID: 2},
			&store.StoreGroup{GroupID: 0, WebsiteID: 0, Name: `Default`, Code: `admin`, RootCategoryID: 0, DefaultStoreID: 0},
			&store.StoreGroup{GroupID: 2, WebsiteID: 1, Name: `UK Group`, Code: `uk`, RootCategoryID: 2, DefaultStoreID: 4},
		),
		store.WithStores(
...
func NewServiceEuroW11G11S19(opts ...store.Option) *store.Service {
	defaultOpts := []store.Option{
		...
		store.WithGroups(
			&store.StoreGroup{Name: `Admin`, Code: "admin"},
			&store.StoreGroup{GroupID: 2, WebsiteID: 2, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 2},
			&store.StoreGroup{GroupID: 7, WebsiteID: 7, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 15},
			&store.StoreGroup{GroupID: 8, WebsiteID: 8, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 17},
			&store.StoreGroup{GroupID: 11, WebsiteID: 11, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 20},
			&store.StoreGroup{GroupID: 9, WebsiteID: 9, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 18},
			&store.StoreGroup{GroupID: 6, WebsiteID: 6, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 13},
			&store.StoreGroup{GroupID: 4, WebsiteID: 4, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 10},
			&store.StoreGroup{GroupID: 5, WebsiteID: 5, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 12},
			&store.StoreGroup{GroupID: 3, WebsiteID: 3, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 6},
			&store.StoreGroup{GroupID: 10, WebsiteID: 10, Code: `b2c`, Name: `b2c`, RootCategoryID: 2, DefaultStoreID: 19},
		),
		store.WithStores(
